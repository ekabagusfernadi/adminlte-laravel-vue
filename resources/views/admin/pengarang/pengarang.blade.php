            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <table id="tableNich" class="table table-striped">
                        ...
                        <tbody>
                            @foreach( $data_pengarang as $index => $value )
                            <tr>
                                <td>{{ ++$index }}</td>
                ...
                <input type="hidden" name="_method" value="PUT" v-if="editStatus">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_pengarang" id="nama_pengarang" v-bind:value="dataPengarang.nama_pengarang" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="email" v-bind:value="dataPengarang.email" required>
                            @error('email')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="telp" id="telp" v-bind:value="dataPengarang.telp" required>
                            @error('telp')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="alamat" id="alamat" v-bind:value="dataPengarang.alamat" required>
                            @error('alamat')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
...
<script>
    const controller = new Vue({
        ...
        methods: {
            ...
            ubahData: function(pengarang) {
                this.editStatus = true;
                this.dataPengarang = pengarang;
                this.actionUrl = "{{ url('data/pengarang') }}" + "/" + pengarang.id;

                $("#modal-nich").modal();
            },
            hapusData: function(idPengarang) {
                this.actionUrl = `{{ url('data/pengarang/${idPengarang}') }}`
